...
savefig('channel_realization_caseI.fig'); % Save the figure as .fig
saveas(gcf, 'channel_realization_caseI.jpg', 'jpeg');
...
savefig('signal_realization_caseI.fig'); % Save the figure as .fig
saveas(gcf, 'signal_realization_caseI.jpg', 'jpeg');
%% KALMAL FILTER %%%%%%%%%%%%%%%%%%%
...
ylabel('Tap weight, hn[1]')
xlabel('Sample number, n')
savefig('tapWeight_caseI.fig'); % Save the figure as .fig
saveas(gcf, 'tapWeight_caseII.jpg', 'jpeg');
...
xlabel('Sample number, n')
savefig('KalmanGain_caseI.fig'); % Save the figure as .fig
saveas(gcf, 'KalmanGain_caseI.jpg', 'jpeg');
% MMSE
figure;
subplot(2,1,1)
...
savefig('MMSE_caseI.fig'); % Save the figure as .fig
saveas(gcf, 'MMSE_caseI.jpg', 'jpeg');
